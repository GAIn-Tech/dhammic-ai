...
# ]
# ///
"""HF Job: g7_d160_l4_eng4k (gen 7)"""
import os, json, sys, time, re
from pathlib import Path
from huggingface_hub import HfApi, hf_hub_download, snapshot_download

MUTATION = "g7_d160_l4_eng4k"
GEN_ID = 7
OVERRIDES = {"d_model": 160, "n_layers": 4, "mamba_expand": 3, "lr": 0.01, "engram_n_columns": 4096, "engram_cells_per_col": 8}
