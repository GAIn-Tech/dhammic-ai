...
# ]
# ///
"""HF Job: pretrain_d192_10k (gen 5)"""
import os, json, sys, time, re
from pathlib import Path
from huggingface_hub import HfApi, hf_hub_download, snapshot_download

MUTATION = "pretrain_d192_10k"
GEN_ID = 5
OVERRIDES = {"d_model": 192, "n_layers": 4, "mamba_expand": 3, "lr": 0.01, "max_steps": 10000, "cosine_period": 5000, "batch_size": 32}
