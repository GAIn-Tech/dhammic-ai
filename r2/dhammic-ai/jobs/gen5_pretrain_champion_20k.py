...
# ]
# ///
"""HF Job: pretrain_champion_20k (gen 5)"""
import os, json, sys, time, re
from pathlib import Path
from huggingface_hub import HfApi, hf_hub_download, snapshot_download

MUTATION = "pretrain_champion_20k"
GEN_ID = 5
OVERRIDES = {"d_model": 128, "n_layers": 4, "mamba_expand": 3, "lr": 0.01, "max_steps": 20000, "cosine_period": 10000, "batch_size": 32}
