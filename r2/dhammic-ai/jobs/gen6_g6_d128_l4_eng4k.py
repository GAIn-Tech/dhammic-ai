...
# ]
# ///
"""HF Job: g6_d128_l4_eng4k (gen 6)"""
import os, json, sys, time, re
from pathlib import Path
from huggingface_hub import HfApi, hf_hub_download, snapshot_download

MUTATION = "g6_d128_l4_eng4k"
GEN_ID = 6
OVERRIDES = {"d_model": 128, "n_layers": 4, "mamba_expand": 3, "lr": 0.01, "engram_n_columns": 4096, "engram_cells_per_col": 8}
